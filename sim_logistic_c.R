...
Q <- matrix(c(-0.903063, 0.217162, 0.556967, 0.128935, 0.253091, -1.112976, 0.210768, 0.649117, 0.649117, 0.210768, -1.112976, 0.253091, 0.128935, 0.556967, 0.217162, -0.903063),
            nrow=4, ncol=4, byrow=T)

PI <- c(0.269101, 0.230899, 0.230899, 0.269101)

null_tree = ape::read.tree("bird_tree.txt")
...
save.image(file="sim_logistic_c.RData")
...
for (i in 1:NSIM) {
  sim_i = get_ith_sim(i)
  cmdstanr::write_stan_json(sim_i, sprintf("sim_logistic_c/sim_logistic_c_%d.json", i))
}
